...
# | \*\*DHCP Scope\*\* | Automatic Address Allocation | `10.0.0.2` to `10.0.0.99 /24` \*(Note: All hosts configured statically for this lab)\* |
...
# | \*\*DNS Resolution\*\* | Primary DNS Server | `8.8.8.8` |
